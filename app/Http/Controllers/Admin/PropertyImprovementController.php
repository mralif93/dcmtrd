...
class PropertyImprovementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.property-improvements.index', compact('improvements'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.property-improvements.create', compact('checklists'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('property-improvements.show', $propertyImprovement)
    ...
    public function show(PropertyImprovement $propertyImprovement)
    {
        ...
        return view('admin.property-improvements.show', compact('propertyImprovement'));
    }
     ...
     * @return \Illuminate\View\View
     */
    public function edit(PropertyImprovement $propertyImprovement)
    {
        $checklists = Checklist::with('property')
            ->where('type', 'improvement')
            ->get();
            
        return view('admin.property-improvements.edit', compact('propertyImprovement', 'checklists'));
    }
    ...
    public function destroy(PropertyImprovement $propertyImprovement)
    {
        ...
        return redirect()->route('property-improvements.index')
    ...
    public function propertyImprovements($propertyId)
    {
        ...
        return view('property-improvements.property', compact('improvements', 'property'));
    }
}
