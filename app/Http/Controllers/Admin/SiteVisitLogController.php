...
class SiteVisitLogController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.site-visit-logs.index', compact('siteVisitLogs'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.site-visit-logs.create', compact('siteVisits'));
    }
     ...
     */
    public function show(SiteVisitLog $siteVisitLog)
    {
        $siteVisitLog->load('siteVisit');
        return view('admin.site-visit-logs.show', compact('siteVisitLog'));
    }

    /**
     * Show the form for editing the specified resource.
     */
    public function edit(SiteVisitLog $siteVisitLog)
    {
        $siteVisits = SiteVisit::all();
        return view('admin.site-visit-logs.edit', compact('siteVisitLog', 'siteVisits'));
    }

    /**
     * Update the specified resource in storage.
     */
    public function update(Request $request, SiteVisitLog $siteVisitLog)
    {
        $validator = Validator::make($request->all(), [
            'site_visit_id' => 'required|exists:site_visits,id',
            'no' => 'required|integer',
     ...
     */
    public function destroy(SiteVisitLog $siteVisitLog)
    {
     ...
     */
    public function downloadReport(SiteVisitLog $siteVisitLog)
    {
        if (!$siteVisitLog->report_attachment) {
