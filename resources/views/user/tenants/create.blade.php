    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('tenants-info.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input id="commencement_date" type="date" name="commencement_date" value="{{ old('commencement_date') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
