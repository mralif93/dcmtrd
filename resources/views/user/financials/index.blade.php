                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($financials as $financial)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $financial->financialType->name }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">No financial records found</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
