                ...
                <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                    ...
                    <a href="{{ route('compliance-covenants.index') }}" 
                       class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        ...
                        Back to Active Covenants
                    </a>
                </div>

                <!-- Trashed Compliance Covenants Table -->
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $covenant->deleted_at->format('d/m/Y H:i') }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        <form action="{{ route('compliance-covenants.force-delete', $covenant->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to permanently delete this compliance covenant? This action cannot be undone.');" class="inline">
                                            @csrf
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center">
                                    <div class="text-sm text-gray-500">No trashed compliance covenants found.</div>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
