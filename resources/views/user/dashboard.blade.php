                            ...
                            @forelse ($issuers as $issuer)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        <a href="{{ route('issuer-search.show', $issuer) }}" class="cursor-pointer text-blue-600 hover:text-blue-900">
                                            {{ $issuer->issuer_name }}
                                        </a>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('issuers-info.edit', $issuer) }}" class="text-blue-600 hover:text-blue-900">
