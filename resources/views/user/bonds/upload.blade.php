<x-app-layout>
    ...
    <div class="flex justify-center py-12">
        <div class="w-full max-w-lg p-8 bg-white rounded-lg shadow-lg">
            ...
            <form action="{{ route('bonds-info.upload-store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <!-- File Input -->
                <div class="mb-4">
                    <label class="block mb-2 font-medium text-gray-700">Choose Bond File</label>
                    <input type="file" name="bond_file" class="w-full p-2 border rounded" required>
                </div>
