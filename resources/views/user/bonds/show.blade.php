                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-4">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900">{{ $bond->issue_date ? $bond->issue_date->format('d/m/Y') : 'N/A' }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Maturity Date</dt>
                                <dd class="mt-1 text-sm text-gray-900">{{ $bond->maturity_date ? $bond->maturity_date->format('d/m/Y') : 'N/A' }}</dd>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <div>
