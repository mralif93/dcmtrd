        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                    <h3 class="text-lg font-medium text-gray-900">Trashed Facilities</h3>
                    <a href="{{ route('facility-informations-info.index') }}" 
                       class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        ...
                        Back to Active Facilities
                    </a>
                </div>

                <!-- Trashed Facilities Table -->
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($trashedFacilities as $facility)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $facility->deleted_at->format('d/m/Y H:i') }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <form action="{{ route('facility-informations-info.restore', $facility->id) }}" method="POST" class="inline">
                                            @csrf
                                        ...
                                        <form action="{{ route('facility-informations-info.force-delete', $facility->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to permanently delete this facility? This action cannot be undone.');" class="inline">
                                            @csrf
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center">
                                    <div class="text-sm text-gray-500">No trashed facilities found.</div>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
