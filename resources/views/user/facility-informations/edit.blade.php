                    ...
                    <div class="space-y-6 pb-6">
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <div class="flex items-start">
                                        <div class="flex items-center h-5 mt-6">
                                            <input type="checkbox" name="guaranteed" id="guaranteed" value="1" @checked(old('guaranteed', $facility->guaranteed))
                                ...
                                <div id="guaranteed_amount_div" class="{{ old('guaranteed', $facility->guaranteed) ? '' : 'hidden' }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="availability_date" id="availability_date" 
                                        value="{{ old('availability_date', $facility->availability_date ? $facility->availability_date->format('Y-m-d') : '') }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="prepared_by" id="prepared_by" 
                                        value="{{ old('prepared_by', $facility->prepared_by) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="verified_by" id="verified_by" 
                                        value="{{ old('verified_by', $facility->verified_by) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div class="md:col-span-2">
                                    <label for="remarks" class="block text-sm font-medium text-gray-700">Remarks</label>
                                    <textarea name="remarks" id="remarks" rows="3"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('remarks', $facility->remarks) }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4">
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">
                                        {{ $facility->created_at->format('M j, Y H:i') }}
                                    </dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Last Updated</dt>
                                    <dd class="mt-1 text-sm text-gray-900">
                                        {{ $facility->updated_at->format('M j, Y H:i') }}
                                    </dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Approval Status</dt>
                                    <dd class="mt-1 text-sm text-gray-900">
                                        {{ $facility->approval_datetime ? 'Approved on ' . $facility->approval_datetime->format('M j, Y H:i') : 'Not Approved' }}
                                    </dd>
                                </div>
                            </dl>
                        </div>
