        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a :href="route('main') " :active="request()->routeIs('main')">
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role == 'user' && Auth::user()->hasPermission('DCMTRD'))
                        ...
                        <x-nav-link :href="route('compliance-covenants-info.index') " :active="request()->routeIs('compliance-covenants-info.index')">
