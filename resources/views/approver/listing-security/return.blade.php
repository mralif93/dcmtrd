    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <form action="{{ route('return-documents-a.approval', $security->id) }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" id="status_display" value="Return" disabled
                        ...
                        <!-- Withdrawal Date -->
                        <div>
                            <label for="return_date" class="block text-sm font-medium text-gray-700">Return Date
                                *</label>
