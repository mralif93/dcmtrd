        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                ...
                <div class="px-4 py-4 border-t border-gray-200 bg-gray-50 sm:px-6">
                    <form method="GET" action="{{ route('activity-diary-a.index') }}">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                            ...
                            <div class="flex items-end">
                                ...
                                @if (request('issuer_id') || request('status') || request('due_date'))
                                    <a href="{{ route('activity-diary-a.index') }}"
                ...
                <div class="bg-white border-b border-gray-200">
                    <nav class="flex -mb-px">
                        <a href="{{ route('activity-diary-a.index') }}"
                            class="px-6 py-4 text-sm font-medium text-indigo-600 border-b-2 border-indigo-500 whitespace-nowrap">
                            All Activities
                        </a>
                        <a href="{{ route('activity-diary-a.upcoming') }}"
                            class="px-6 py-4 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 hover:border-gray-300 whitespace-nowrap">
                            Upcoming
                        </a>
                    </nav>
                </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            <a href="{{ route('activity-diary-a.show', $activity) }}"
                                                ...
                                                {{ $activity->issuer->issuer_short_name ?? 'N/A' }} -
                                                {{ $activity->issuer->issuer_name ?? 'N/A' }}
                                            </a>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
