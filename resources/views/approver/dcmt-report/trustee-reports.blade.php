<x-app-layout>
    <x-slot name="header">
        <h2 class="text-3xl font-semibold text-gray-800">{{ __('Trust Master Reports') }}</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-0">
                <form method="GET" action="{{ route('a.dcmt-reports.trustee-reports.a') }}"
                ...
                <div class="flex flex-wrap justify-end gap-2">
                    ...
                    <form method="POST" action="{{ route('a.dcmt-reports.trustee-reports.cutoff.a') }}">
                        @csrf
                        <button type="submit"
