<x-app-layout>
    <x-slot name="header">
        <h2 class="text-3xl font-bold text-gray-800">{{ __('Trustee Master Reports') }}</h2>
    </x-slot>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex space-x-3">
                                            {{-- Download Button --}}
                                            <a href="{{ route('a.dcmt-reports.trustee-reports.download.a', $batch->id) }}"
                                            ...
                                            {{-- Delete Button --}}
                                            <form action="{{ route('a.dcmt-reports.cb-reports.delete.a', $batch->id) }}"
                                                method="POST"
