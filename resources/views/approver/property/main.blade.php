        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="border-b border-gray-200">
                    ...
                    <a href="{{ route('property-a.main', ['tab' => 'all'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('property-a.main', ['tab' => 'pending'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('property-a.main', ['tab' => 'rejected'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('property-a.main', ['tab' => 'active'] + request()->except('page', 'tab')) }}" 
                ...
                <div class="px-4 py-3 bg-gray-50 sm:px-6">
                    <form action="{{ route('property-a.main') }}" method="GET" class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        ...
                        <div class="flex items-end space-x-3">
                            ...
                            <a href="{{ route('property-a.main', ['tab' => $activeTab]) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Reset
                            </a>
                        </div>
                    </form>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ ucfirst($property->category) }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ Str::limit($property->address, 30) }}</div>
                                    <div class="text-sm text-gray-500">{{ $property->city }}, {{ $property->state }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        {{ $property->market_value ? 'RM ' . number_format($property->market_value, 2) : 'N/A' }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="flex justify-end space-x-2">
                                        @if($property->status == 'pending')
                                            ...
                                            <form method="POST" action="{{ route('property-a.approve', $property) }}" class="inline">
                                                @csrf
                                                <button type="submit" class="text-green-600 hover:text-green-900" title="Approve Property">
                                            ...
                                            <button onclick="openRejectModal('{{ $property->id }}')" class="text-red-600 hover:text-red-900" title="Reject Property">
                                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <a href="{{ route('property-a.details', $property) }}" class="text-indigo-600 hover:text-indigo-900" title="View Details">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-4 text-center">
                                    <div class="text-sm text-gray-500">No properties found.</div>
                                </td>
                            </tr>
                            @endif
                        </tbody>
