            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="border-b border-gray-200">
                    <nav class="-mb-px flex px-6 space-x-6">
                        <a href="{{ route('appointment-a.main', ['tab' => 'all'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('appointment-a.main', ['tab' => 'pending'] + request()->except('page', 'tab')) }}" 
						...
						<a href="{{ route('appointment-a.main', ['tab' => 'active'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('appointment-a.main', ['tab' => 'rejected'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('appointment-a.main', ['tab' => 'inactive'] + request()->except('page', 'tab')) }}" 
                ...
                <div class="px-4 py-3 bg-gray-50 sm:px-6">
                    <form action="{{ route('appointment-a.main') }}" method="GET" class="grid grid-cols-1 gap-3 md:grid-cols-3">
                        ...
                        <div class="flex items-end space-x-3">
                            ...
                            <a href="{{ route('appointment-a.main', ['tab' => $activeTab]) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Reset
                            </a>
                        </div>
                    </form>
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">
                                        <a href="{{ route('appointment-a.show', $appointment) }}" class="text-indigo-600 hover:text-indigo-900">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <a href="{{ route('appointment-a.details', $appointment) }}" class="text-indigo-600 hover:text-indigo-900" title="View Details">
                                        ...
                                        @if($appointment->status == 'pending')
                                            ...
                                            <form method="POST" action="{{ route('appointment-a.approve', $appointment) }}" class="inline">
                                                @csrf
                                                <button type="submit" class="text-green-600 hover:text-green-900" title="Approve Appointment">
                                            ...
                                            <button onclick="openRejectModal('{{ $appointment->id }}')" class="text-red-600 hover:text-red-900" title="Reject Appointment">
                                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
