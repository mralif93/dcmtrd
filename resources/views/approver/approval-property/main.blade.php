    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Approval Property Management') }}
            </h2>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                    <h3 class="text-lg font-medium text-gray-900">Approval Properties</h3>
                </div>

                <!-- Status Tabs -->
                <div class="border-b border-gray-200">
                    <nav class="-mb-px flex px-6 space-x-6">
                        <a href="{{ route('approval-property-a.main', ['tab' => 'all'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('approval-property-a.main', ['tab' => 'pending'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('approval-property-a.main', ['tab' => 'active'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('approval-property-a.main', ['tab' => 'rejected'] + request()->except('page', 'tab')) }}" 
                        ...
                        <a href="{{ route('approval-property-a.main', ['tab' => 'inactive'] + request()->except('page', 'tab')) }}" 
                ...
                <div class="px-4 py-3 bg-gray-50 sm:px-6">
                    <form action="{{ route('approval-property-a.main') }}" method="GET" class="grid grid-cols-1 gap-3 md:grid-cols-3">
                        ...
                        <div class="flex items-end space-x-3">
                            ...
                            <a href="{{ route('approval-property-a.main', ['tab' => $activeTab]) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Reset
                            </a>
                        </div>
                    </form>
                                    ...
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        @if($approvalProperty->status == 'pending')
                                            ...
                                            <form method="POST" action="{{ route('approval-property-a.approve', $approvalProperty) }}" class="inline">
                                                @csrf
                                                <button type="submit" class="text-green-600 hover:text-green-900" title="Approve Approval Property">
                                            ...
                                            <button onclick="openRejectModal('{{ $approvalProperty->id }}')" class="text-red-600 hover:text-red-900" title="Reject Approval Property">
                                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
