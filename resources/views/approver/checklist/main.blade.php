        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="px-4 py-3 bg-gray-50 sm:px-6">
                    <form action="{{ route('checklist-a.main') }}" method="GET" class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <select id="site_visit_id" name="site_visit_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <option value="">All Site Visits</option>
                                @foreach($siteVisits as $siteVisit)
                                    <option value="{{ $siteVisit->id }}" {{ request('site_visit_id') == $siteVisit->id ? 'selected' : '' }}>{{ $siteVisit->property->name ?? 'N/A' }}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">
                                        {{ $checklist->siteVisit->date_visit ? $checklist->siteVisit->date_visit->format('d M Y') : 'N/A' }}
                                    </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        {{ $checklist->approval_datetime ? $checklist->approval_datetime->format('d M Y') : 'N/A' }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <a href="{{ route('checklist-a.details', $checklist) }}" class="text-indigo-600 hover:text-indigo-900" title="View Details">
                                        ...
                                        @if($checklist->status == 'pending')
                                            ...
                                            <button onclick="openRejectModal('{{ $checklist->id }}')" class="text-red-600 hover:text-red-900" title="Reject Checklist">
                                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form id="rejectForm" method="POST" action="">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="rejection_reason" name="remarks" rows="3" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required></textarea>
                    </div>
