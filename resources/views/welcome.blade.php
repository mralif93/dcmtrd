    ...
    <body class="font-sans">
        <div class="container relative flex flex-col items-center justify-center px-4 py-12 mx-auto">
            ...
            <div class="{{ $containerClass }}">
                ...
                <a href="{{ route('dashboard', ['section' => 'dcmtrd']) }}" class="shadow-lg card bond-card">
                    <div class="p-8">
                ...
                <!-- Card 2: REITs -->
                <a href="{{ route('dashboard', ['section' => 'reits']) }}" class="shadow-lg card reit-card">
                    <div class="p-8">
                ...
                <a href="{{ route('dashboard', ['section' => 'legal']) }}" class="shadow-lg card legal-card">
                    <div class="p-8">
                ...
                <!-- Card 4: Compliance -->
                <a href="{{ route('dashboard', ['section' => 'compliance']) }}" class="shadow-lg card compliance-card">
                    <div class="p-8">
