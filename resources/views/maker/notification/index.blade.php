                ...
                <div class="bg-white border-b border-gray-200">
                    ...
                    <div class="border-b border-gray-200">
                        <nav class="flex px-6 -mb-px space-x-6">
                            <button type="button" onclick="switchTab('lease')"
                                ...
                                Lease
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs rounded-full bg-gray-100">{{ $activeLeasesCount ?? 0 }}</span>
                            </button>
                            ...
                            <button type="button" onclick="switchTab('siteVisit')"
                                ...
                                Site Visits
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs rounded-full bg-gray-100">{{ $activeSiteVisitsCount ?? 0 }}</span>
                            </button>
                            ...
                            <button type="button" onclick="switchTab('siteVisitLog')"
                                ...
                                Activity Diary
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs rounded-full bg-gray-100">{{ $activeSiteVisitLogsCount ?? 0 }}</span>
                            </button>
                            ...
                            <button type="button" onclick="switchTab('appointments')"
                                ...
                                Appointments
                                <span
                                    class="ml-2 py-0.5 px-2.5 text-xs rounded-full bg-gray-100">{{ $activeAppointmentsCount ?? 0 }}</span>
                            </button>
                        </nav>
                    </div>
                    ...
                    <div id="content-lease" class="tab-content {{ $activeTab != 'lease' ? 'hidden' : '' }}">
                        <div class="p-6 overflow-x-auto">
                            <table
                                class="min-w-full overflow-hidden bg-white border-b border-gray-200 divide-y divide-gray-200 shadow sm:rounded-lg">
                                        ...
                                        @php
                                            ...
                                            if ($daysRemaining < 0) {
                                                ...
                                                $timeRemaining =
                                                    (int) $daysRemaining .
                                                    ' ' .
                                                    Str::plural('day', (int) $daysRemaining);
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ $lease->tenant->property->portfolio->portfolio_name ?? 'N/A' }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ $lease->tenant->property->name ?? 'N/A' }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ $lease->tenant->name ?? 'N/A' }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">
                                            ...
                                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('lease-m.show', $lease->id) }}"
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse($siteVisits as $siteVisit)
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ $siteVisit->property->name ?? 'N/A' }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ date('d/m/Y', strtotime($siteVisit->date_visit)) }} /
                                            ...
                                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('site-visit-m.show', $siteVisit->id) }}"
                                                        class="text-indigo-600 hover:text-indigo-900">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div id="content-siteVisitLog"
                        class="tab-content {{ $activeTab != 'siteVisitLog' ? 'hidden' : '' }}">
                        <div class="p-6 overflow-x-auto">
                            <table
                                class="min-w-full overflow-hidden bg-white border-b border-gray-200 divide-y divide-gray-200 shadow sm:rounded-lg">
                                <thead class="bg-gray-50">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse($siteVisitLogs as $siteVisitLog)
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('site-visit-log-m.show', $siteVisitLog->id) }}"
                                                        class="text-indigo-600 hover:text-indigo-900">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div id="content-appointments"
                        class="tab-content {{ $activeTab != 'appointments' ? 'hidden' : '' }}">
                        <div class="p-6 overflow-x-auto">
                            <table
                                class="min-w-full overflow-hidden bg-white border-b border-gray-200 divide-y divide-gray-200 shadow sm:rounded-lg">
                                <thead class="bg-gray-50">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    {{ $appointment->party_name ?? 'N/A' }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                            ...
                                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('appointment-m.show', $appointment) }}"
                                                        class="text-indigo-600 hover:text-indigo-900">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
