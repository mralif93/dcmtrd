                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                @if($property->master_lease_agreement)
                                    <div class="flex items-center">
                                        ...
                                        <a href="{{ asset('property-documents/' . $property->master_lease_agreement) }}" target="_blank" class="text-indigo-600 hover:text-indigo-900">
                                            View Attachment
                                        </a>
                                    </div>
                                @else
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                @if($property->valuation_report)
                                    <div class="flex items-center">
                                        ...
                                        <a href="{{ asset('property-documents/' . $property->valuation_report) }}" target="_blank" class="text-indigo-600 hover:text-indigo-900">
                                            View Attachment
                                        </a>
                                    </div>
                                @else
