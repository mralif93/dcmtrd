                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        <tr>
                                            <td class="px-4 py-3">
                                                <input id="tenant_name" type="text" name="tenant_name" value="{{ old('tenant_name') }}" placeholder="Tenant Name" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                            </td>
                                            <td class="px-4 py-3">
                                                <input id="tenant_property" type="text" name="tenant_property" value="{{ old('tenant_property') }}" placeholder="Property" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                            </td>
                                            <td class="px-4 py-3">
                                                <input id="tenancy_approval_date" type="date" name="tenancy_approval_date" value="{{ old('tenancy_approval_date') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                            </td>
                                            <td class="px-4 py-3">
                                                <input id="tenancy_commencement_date" type="date" name="tenancy_commencement_date" value="{{ old('tenancy_commencement_date') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                            </td>
                                            <td class="px-4 py-3">
                                                <input id="tenancy_expiry_date" type="date" name="tenancy_expiry_date" value="{{ old('tenancy_expiry_date') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
