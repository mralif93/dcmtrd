        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('checklist-disposal-installations.update', $disposalInstallation) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="checklist_id" name="checklist_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                        ...
                                        @foreach($checklists as $checklist)
                                            <option value="{{ $checklist->id }}" {{ old('checklist_id', $disposalInstallation->checklist_id) == $checklist->id ? 'selected' : '' }}>
                                                {{ $checklist->id }} - {{ $checklist->name ?? 'Checklist #' . $checklist->id }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('checklist_id')
                                ...
                                <div>
                                    ...
                                    <input id="component_name" type="text" name="component_name" value="{{ old('component_name', $disposalInstallation->component_name) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input id="component_date" type="date" name="component_date" value="{{ old('component_date', $disposalInstallation->component_date ? $disposalInstallation->component_date->format('Y-m-d') : '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <select id="component_status" name="component_status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <option value="active" {{ old('component_status', $disposalInstallation->component_status) == 'active' ? 'selected' : '' }}>Active</option>
                                        <option value="inactive" {{ old('component_status', $disposalInstallation->component_status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        <option value="pending" {{ old('component_status', $disposalInstallation->component_status) == 'pending' ? 'selected' : '' }}>Pending</option>
                                    </select>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea id="component_scope_of_work" name="component_scope_of_work" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('component_scope_of_work', $disposalInstallation->component_scope_of_work) }}</textarea>
