    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <form action="{{ route('announcement-m.store', $issuerInfo) }}" method="POST" class="p-6" enctype="multipart/form-data">
                    @csrf
                    <div class="pb-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-sm text-gray-500">Upload optional supporting documents.</p>
                                @error('attachment')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
