            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('activity-diaries-info.edit', $activityDiary) }}" 
                ...
                @if($activityDiary->status != 'completed')
                    <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                        ...
                        <form action="{{ route('activity-diaries-info.update-status', $activityDiary) }}" method="POST" class="flex items-center">
                            @csrf
                            @method('PATCH')
                ...
                <div class="border-t border-gray-200 px-4 py-4 sm:px-6">
                    <div class="flex justify-end space-x-3">
                        ...
                        <form action="{{ route('activity-diaries-info.destroy', $activityDiary) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this activity diary?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
