        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="border-t border-gray-200 px-4 py-4 sm:px-6">
                    ...
                    <!-- Action Buttons Row - Always at bottom, right-aligned -->
                    <div class="flex justify-end space-x-3 border-t border-gray-100 pt-4">
                        ...
                        <form action="{{ route('activity-diary-m.destroy', $activity) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this activity diary?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
