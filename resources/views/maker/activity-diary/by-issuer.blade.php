                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            @if ($activity->status !== 'Completed' && $activity->status !== 'Pending' && $activity->status !== 'Rejected' && $activity->status !== 'Draft')
                                                <form
                                                    action="{{ route('activity-diary-m.update-status', $activity) }}"
                                                    method="POST" class="inline">
                                                    @csrf
                                                    @method('PATCH')
                                                    <input type="hidden" name="status" value="Completed">
                                                    <button type="submit"
                                                        onclick="return confirm('Mark this activity as completed?');"
