    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <form action="{{ route('document-m.store', $issuer) }}" method="POST" class="p-6"
                    ...
                    <div class="pb-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="upload_date" id="upload_date"
                                ...
                                class="block w-full mt-1 bg-gray-100 border-gray-300 rounded-md shadow-sm cursor-not-allowed focus:border-indigo-500 focus:ring-indigo-500">
                            @error('upload_date')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
