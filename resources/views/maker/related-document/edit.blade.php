    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <form action="{{ route('document-m.update', $document) }}" method="POST" class="p-6"
                    ...
                    <div class="pb-6 space-y-6">
                        ...
                        <!-- Row 2: Document Name -->
                        <div>
                            <label for="document_name" class="block text-sm font-medium text-gray-700">Document Name
                                *</label>
                        ...
                        <!-- Row 4: Upload Date -->
                        <div>
                            <label for="upload_date" class="block text-sm font-medium text-gray-700">Upload Date
                                *</label>
                        ...
                        <div>
                            <label for="file_path" class="block text-sm font-medium text-gray-700">Document File (Leave
                                blank to keep current file)</label>
                            ...
                            @if ($document->file_path)
                                <p class="mt-2 text-sm text-gray-500">Current Attachment:
                                    <a href="{{ Storage::url($document->file_path) }}" class="text-blue-600 underline"
                    ...
                    <div class="flex justify-end gap-4 pt-6 border-t border-gray-200">
                        <a href="{{ route('facility-info-m.show', $facilities) }}"
