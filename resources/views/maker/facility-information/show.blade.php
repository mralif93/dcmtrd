                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-xs font-medium text-left text-gray-500 uppercase">Agency</th>
                                    ...
                                    <th class="px-6 py-3 text-xs font-medium text-left text-gray-500 uppercase">Outlook</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($ratingMovements as $movement)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm whitespace-nowrap">{{ $movement->effective_date->format('d M Y') }}</td>
                                    <td class="px-6 py-4 text-sm whitespace-nowrap">{{ $movement->rating_agency }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs text-blue-800 bg-blue-100 rounded-full">
                                            {{ $movement->rating }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-sm whitespace-nowrap">{{ $movement->rating_action }}</td>
                                    <td class="px-6 py-4 text-sm whitespace-nowrap">{{ $movement->rating_outlook }}</td>
                                </tr>
                                @empty
                                <tr>
