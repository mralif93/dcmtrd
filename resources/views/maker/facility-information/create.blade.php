    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <form action="{{ route('facility-info-m.store', $issuerInfo) }}" method="POST" class="p-6 space-y-8">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                ...
                                <input type="number" name="facility_code" id="facility_code" 
                    ...
                    <div class="pb-6 mt-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                <label for="outstanding_amount" class="block text-sm text-gray-700 font -medium">Outstanding (RM)</label>
