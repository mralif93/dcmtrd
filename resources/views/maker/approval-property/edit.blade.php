        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('approval-property.update', $approvalProperty) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input id="prepared_by" type="text" name="prepared_by" value="{{ old('prepared_by', $approvalProperty->prepared_by) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('prepared_by')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input id="verified_by" type="text" name="verified_by" value="{{ old('verified_by', $approvalProperty->verified_by) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('verified_by')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input id="approval_datetime" type="datetime-local" name="approval_datetime" value="{{ old('approval_datetime', $approvalProperty->approval_datetime ? $approvalProperty->approval_datetime->format('Y-m-d\TH:i') : '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                @if($approvalProperty->attachment)
                                    <div class="col-span-2">
                                        ...
                                        <div class="mt-2 flex items-center">
                                            ...
                                            <a href="{{ $approvalProperty->attachment_url }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                        ...
                        <div class="border-t border-gray-200 py-4 mt-6">
                            <div class="flex justify-end gap-4">
                                <a href="{{ route('approval-property.index') }}" 
