    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <form action="{{ route('site-visit-log-m.update', $siteVisitLog) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="property_id" id="property_id" required
                                        ...
                                        @foreach($properties as $property)
                                            <option value="{{ $property->id }}" @selected(old('property_id', $siteVisitLog->property_id) == $property->id)>
                                ...
                                <div>
                                    ...
                                    <select name="category" id="category"
                                        ...
                                        <option value="meeting" @selected(old('category', $siteVisitLog->category) == 'meeting')>Meeting</option>
                                        <option value="inspection" @selected(old('category', $siteVisitLog->category) == 'inspection')>Inspection</option>
                                        <option value="maintenance" @selected(old('category', $siteVisitLog->category) == 'maintenance')>Maintenance</option>
                                        <option value="others" @selected(old('category', $siteVisitLog->category) == 'others')>Others</option>
                                    </select>
                                </div>
                                        ...
                                        <div>
                                            <select name="visit_year" id="visit_year"
                                                ...
                                                @for($i = date('Y'); $i >= date('Y') - 10; $i--)
                                                    <option value="{{ $i }}" @selected(old('visit_year', $siteVisitLog->visit_year) == $i)>{{ $i }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
