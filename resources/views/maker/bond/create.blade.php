            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <form action="{{ route('bond-m.store', $issuerInfo) }}" method="POST" class="p-6">
                    ...
                    <div class="space-y-6 pb-6 border-b border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="principal" id="principal" value="{{ old('principal') }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="islamic_concept" id="islamic_concept" value="{{ old('islamic_concept') }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="instrument_code" id="instrument_code" value="{{ old('instrument_code') }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div>
                    ...
                    <div class="flex justify-end gap-4 pt-6">
                        <a href="{{ route('bond-m.index', $issuer) }}"
