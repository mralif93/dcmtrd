    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                ...
                <form action="{{ route('bond-m.store', $issuerInfo) }}" method="POST" class="p-6">
                    @csrf
                    ...
                    <div class="pb-6 space-y-6 border-b border-gray-200">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="islamic_concept" id="islamic_concept" value="{{ old('islamic_concept') }}"
                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="instrument_code" id="instrument_code" value="{{ old('instrument_code') }}"
                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.0001" name="residual_tenure_years" id="residual_tenure_years"
                                    value="{{ old('residual_tenure_years') }}"
                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <p class="mt-1 text-xs text-gray-500">Up to 4 decimal places</p>
                            </div>
                        </div>
                    ...
                    <div class="py-6 space-y-6 border-b border-gray-200">
                    ...
                    <div class="flex justify-end gap-4 pt-6">
                        <a href="{{ route('bond-m.details', $issuerInfo) }}"
