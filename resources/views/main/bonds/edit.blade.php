    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <form action="{{ route('bond-details.update', $bond) }}" method="POST" class="p-6">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="space-y-6 pb-6">
                        <h3 class="text-lg font-bold text-gray-900 mb-4">System Informations</h3>
                    ...
                    <div class="flex justify-end gap-4 border-t border-gray-200 pt-6">
                        <a href="{{ route('issuer-search.show', $bond->issuer) }}"
