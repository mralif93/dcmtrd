<x-app-layout>
    ...
    <div class="py-8">
        <div class="mx-auto space-y-4 max-w-7xl sm:px-6 lg:px-8">
            <h1 class="text-xl">
                <strong class="text-gray-700">Issuer Name:</strong> {{ $issuer->issuer_name }}
            </h1>
                ...
                <button @click="openSection = openSection === 'general' ? null : 'general'"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <svg class="w-6 h-6 transition-transform transform"
                            :class="{ 'rotate-180': openSection === 'general' }" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <button @click="openSection = openSection === 'ratings' ? null : 'ratings'"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <svg class="w-6 h-6 transition-transform transform"
                            :class="{ 'rotate-180': openSection === 'ratings' }" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($ratingMovements as $movement)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-sm whitespace-nowrap">{{ $movement->rating_outlook }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
