            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="border-t border-gray-200">
                    <dl>
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $checklist->status === 'Approved' ? 'bg-green-100 text-green-800' : ($checklist->status === 'Scheduled' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800') }}">
                                    {{ $checklist->status }}
                                </span>
                            </dd>
                        </div>
                ...
                <div class="border-t border-gray-200 px-4 py-4 sm:px-6">
                    <div class="flex justify-end gap-x-4">
                        ...
                        <a href="{{ route('checklist-a.edit', $checklist) }}" 
