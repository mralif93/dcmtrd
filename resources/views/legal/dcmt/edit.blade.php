    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <form action="{{ route('legal.request-documents.update', $documentRequest->id) }}" method="POST" class="p-6">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="flex justify-end gap-4 pt-6 border-gray-200">
                        <a href="{{ route('legal.request-documents.history', $documentRequest->list_security_id) }}"
