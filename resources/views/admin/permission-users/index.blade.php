        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="flex justify-between items-center px-4 py-5 sm:px-6">
                    <h3 class="text-lg font-medium text-gray-900">User Permission Assignments</h3>
                                ...
                                @forelse ($permissionUsers as $permissionUser)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $permissionUser->user->name }}</div>
                                            <div class="text-sm text-gray-500">{{ $permissionUser->user->email }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">{{ $permissionUser->permission->full_name }}</div>
                                            <div class="text-sm text-gray-500">{{ $permissionUser->permission->name }}</div>
                                        </td>
