            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                ...
                <div class="flex items-center justify-between px-4 py-5 sm:px-6">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('admin.issuers.trashed') }}"
                            ...
                            @forelse($issuers as $issuer)
                                <tr class="transition-colors hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">{{ $issuer->issuer_short_name }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $issuer->status == 'Active'
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            <form action="{{ route('issuers.destroy', $issuer) }}" method="POST"
                                                onsubmit="return confirm('Are you sure you want to delete this issuer?');"
                                                class="inline">
                                                @csrf
                                                @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                        No issuers found
                                        {{ request('search') || request('status') ? 'matching your criteria' : '' }}
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
