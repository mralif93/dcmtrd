                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="trust_deed_date" id="trust_deed_date" 
                                    value="{{ old('trust_deed_date', $issuer->trust_deed_date) }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="space-y-6 pb-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="reminder_1" id="reminder_1" 
                                value="{{ old('reminder_1', $issuer->reminder_1) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('reminder_1')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="date" name="reminder_2" id="reminder_2" 
                                value="{{ old('reminder_2', $issuer->reminder_2) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('reminder_2')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="date" name="reminder_3" id="reminder_3" 
                                value="{{ old('reminder_3', $issuer->reminder_3) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('reminder_3')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
