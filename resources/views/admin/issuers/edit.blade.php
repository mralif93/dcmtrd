    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <form action="{{ route('issuers.update', $issuer) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="trust_deed_date" id="trust_deed_date" 
                                    value="{{ old('trust_deed_date', $issuer->trust_deed_date ? $issuer->trust_deed_date->format('Y-m-d') : '') }}" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="prepared_by" id="prepared_by" 
                                    value="{{ old('prepared_by', $issuer->prepared_by) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                @error('prepared_by')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="verified_by" id="verified_by" 
                                    value="{{ old('verified_by', $issuer->verified_by) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                @error('verified_by')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="approval_datetime" id="approval_datetime" 
                                    value="{{ old('approval_datetime', $issuer->approval_datetime ? date('Y-m-d\TH:i', strtotime($issuer->approval_datetime)) : '') }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="space-y-6 pb-6 pt-6 border-t border-gray-200">
