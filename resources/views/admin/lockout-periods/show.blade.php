<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                <p class="mt-2 text-lg text-gray-600">Detailed information about {{ $period->redemption->bondInfo->isin_code }} lockout period</p>
            </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900">
                                    {{ $period->redemption->bondInfo->isin_code }} - 
                                    {{ $period->redemption->bondInfo->stock_code }}
                                </dd>
                            </div>
