                              ...
                              <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                  <div>
                                      ...
                                      <select id="property_id" name="property_id" class="mt-1 block w-full rounded-md border-gray-300">
                                          @foreach($properties as $id => $name)
                                              <option value="{{ $id }}" {{ old('property_id', $selectedProperty) == $id ? 'selected' : '' }}>
                                                  {{ $name }}
                                              </option>
                                          @endforeach
                                      </select>
                                  ...
                                  <div>
                                      ...
                                      <select id="unit_type" name="unit_type" class="mt-1 block w-full rounded-md border-gray-300">
                                          ...
                                          <option value="4BR+" {{ old('unit_type') == '4BR+' ? 'selected' : '' }}>4+ Bedrooms</option>
                                      </select>
                                      @error('unit_type')
                                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                      @enderror
                          ...
                          <div class="border-b pb-6">
                              ...
                              <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                  ...
                                  <div>
                                      ...
                                      <input type="number" id="bedrooms" name="bedrooms" value="{{ old('bedrooms', 1) }}" min="0" 
                                          class="mt-1 block w-full rounded-md border-gray-300">
                                      @error('bedrooms')
                                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                      @enderror
                                  ...
                                  <div>
                                      ...
                                      <input type="number" id="bathrooms" name="bathrooms" value="{{ old('bathrooms', 1) }}" min="0" step="0.5" 
                                          class="mt-1 block w-full rounded-md border-gray-300">
                                      @error('bathrooms')
                                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                      @enderror
                                  ...
                                  <div>
                                      ...
                                      <input type="number" id="ceiling_height" name="ceiling_height" value="{{ old('ceiling_height', 8) }}" step="0.1" 
                                          class="mt-1 block w-full rounded-md border-gray-300">
                                  ...
                                  <div>
                                      ...
                                      <input type="text" id="floor_type" name="floor_type" value="{{ old('floor_type') }}" 
                                          class="mt-1 block w-full rounded-md border-gray-300">
                                      @error('floor_type')
                                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                      @enderror
                                  ...
                                  <div>
                                      ...
                                      <input type="text" id="view_type" name="view_type" value="{{ old('view_type') }}" 
                                          class="mt-1 block w-full rounded-md border-gray-300">
                                      @error('view_type')
                                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                      @enderror
                                  ...
                                  <div>
                                      ...
                                      <select id="exposure" name="exposure" class="mt-1 block w-full rounded-md border-gray-300">
                                          <option value="North" {{ old('exposure') == 'North' ? 'selected' : '' }}>North</option>
                                          <option value="South" {{ old('exposure') == 'South' ? 'selected' : '' }}>South</option>
                                          <option value="East" {{ old('exposure') == 'East' ? 'selected' : '' }}>East</option>
                                          <option value="West" {{ old('exposure') == 'West' ? 'selected' : '' }}>West</option>
                                      </select>
                                      @error('exposure')
                                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                      @enderror
                                  ...
                                  <div>
                                      ...
                                      <input type="date" id="last_renovation" name="last_renovation" value="{{ old('last_renovation') }}" 
                                          class="mt-1 block w-full rounded-md border-gray-300">
                              ...
                              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                  <div>
                                      ...
                                      <div class="mt-1 relative rounded-md shadow-sm">
                                          ...
                                          <input type="number" id="base_rent" name="base_rent" step="0.01" value="{{ old('base_rent') }}" 
                                  ...
                                  <div>
                                      ...
                                      <div class="mt-1 relative rounded-md shadow-sm">
                                          ...
                                          <input type="number" id="utility_cost" name="utility_cost" step="0.01" value="{{ old('utility_cost') }}" 
                                              class="mt-1 block w-full pl-7 rounded-md border-gray-300">
                                      </div>
                                      @error('utility_cost')
                                          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                          ...
                          <div class="border-b pb-6">
                              ...
                              <div class="mt-4">
                                  ...
                                  <textarea id="appliances_included" name="appliances_included" rows="3" 
                                      class="mt-1 block w-full rounded-md border-gray-300">{{ old('appliances_included', '{"refrigerator": true, "dishwasher": true, "stove": true, "microwave": true}') }}</textarea>
