                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select id="portfolio_id" name="portfolio_id" class="mt-1 block w-full rounded-md border-gray-300">
                                        @foreach($portfolios as $id => $name)
                                            <option value="{{ $id }}" {{ old('portfolio_id', $selectedPortfolio) == $id ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status" class="mt-1 block w-full rounded-md border-gray-300">
                                        ...
                                        <option value="Under Renovation" {{ old('status') == 'Under Renovation' ? 'selected' : '' }}>Under Renovation</option>
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="land_area" name="land_area" value="{{ old('land_area') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('land_area')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="number" id="number_of_floors" name="number_of_floors" value="{{ old('number_of_floors') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="zoning_type" name="zoning_type" value="{{ old('zoning_type') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('zoning_type')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select id="building_class" name="building_class" class="mt-1 block w-full rounded-md border-gray-300">
                                        <option value="A" {{ old('building_class') == 'A' ? 'selected' : '' }}>A</option>
                                        <option value="B" {{ old('building_class') == 'B' ? 'selected' : '' }}>B</option>
                                        <option value="C" {{ old('building_class') == 'C' ? 'selected' : '' }}>C</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="primary_use" name="primary_use" value="{{ old('primary_use') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('primary_use')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="number" id="occupancy_rate" name="occupancy_rate" value="{{ old('occupancy_rate', 0) }}" min="0" max="100" step="0.1" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" id="purchase_price" name="purchase_price" step="0.01" value="{{ old('purchase_price') }}" 
                                ...
                                <div>
                                    ...
                                    <input type="number" id="expected_roi" name="expected_roi" step="0.01" value="{{ old('expected_roi') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('expected_roi')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" id="annual_property_tax" name="annual_property_tax" step="0.01" value="{{ old('annual_property_tax') }}" 
                                            class="mt-1 block w-full pl-7 rounded-md border-gray-300">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" id="insurance_cost" name="insurance_cost" step="0.01" value="{{ old('insurance_cost') }}" 
                                            class="mt-1 block w-full pl-7 rounded-md border-gray-300">
                                    </div>
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="property_manager" name="property_manager" value="{{ old('property_manager') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="tax_parcel_id" name="tax_parcel_id" value="{{ old('tax_parcel_id') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('tax_parcel_id')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea id="insurance_details" name="insurance_details" rows="3" 
                                        class="mt-1 block w-full rounded-md border-gray-300">{{ old('insurance_details') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <input type="date" id="last_renovation_date" name="last_renovation_date" value="{{ old('last_renovation_date') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
