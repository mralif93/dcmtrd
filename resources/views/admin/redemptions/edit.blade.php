                    ...
                    <div class="space-y-8 p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <!-- Bond Selection -->
                                <div class="space-y-2">
                                    <label for="bond_id" class="block text-sm font-medium text-gray-700">
                                        Bond Information *
                                    </label>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Select associated bond instrument</p>
                                </div>

                                <!-- Last Call Date -->
                                <div class="space-y-2">
                                    <label for="last_call_date" class="block text-sm font-medium text-gray-700">
                                        Last Call Date *
                                    </label>
                                    <input type="date" name="last_call_date" id="last_call_date" 
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <p class="mt-1 text-sm text-gray-500">Final eligible date for redemption calls</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div class="border-b border-gray-200 pb-4">
                                <h3 class="text-lg font-medium text-gray-900">Call Settings</h3>
                            </div>
