    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <form action="{{ route('redemptions.update', $redemption) }}" method="POST" class="space-y-8 p-6">
                    @csrf @method('PUT')
                                ...
                                <div>
                                    ...
                                    <select name="bond_info_id" id="bond_info_id" required
                                        ...
                                        @foreach($bonds as $bond)
                                            <option value="{{ $bond->id }}" @selected(old('bond_info_id', $redemption->bond_info_id) == $bond->id)>
