    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('site-visits.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="visitor_name" name="visitor_name" value="{{ old('visitor_name') }}" 
                                ...
                                <div>
                                    ...
                                    <input type="email" id="visitor_email" name="visitor_email" value="{{ old('visitor_email') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('visitor_email')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" id="visitor_phone" name="visitor_phone" value="{{ old('visitor_phone') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('visitor_phone')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" id="visit_date" name="visit_date" value="{{ old('visit_date') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('visit_date')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select id="visit_status" name="visit_status" class="mt-1 block w-full rounded-md border-gray-300">
                                        @foreach($visitStatuses as $status)
                                            <option value="{{ $status }}" {{ old('visit_status', 'Scheduled') == $status ? 'selected' : '' }}>
                                                {{ $status }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="conducted_by" name="conducted_by" value="{{ old('conducted_by') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('conducted_by')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <textarea id="visitor_feedback" name="visitor_feedback" rows="3" 
                                        class="mt-1 block w-full rounded-md border-gray-300">{{ old('visitor_feedback') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea id="agent_notes" name="agent_notes" rows="3" 
                                        class="mt-1 block w-full rounded-md border-gray-300">{{ old('agent_notes') }}</textarea>
                                    @error('agent_notes')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="requirements" name="requirements" rows="3" 
                                        class="mt-1 block w-full rounded-md border-gray-300font-mono text-sm">{{ old('requirements', '{}') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" id="quoted_price" name="quoted_price" step="0.01" value="{{ old('quoted_price') }}" 
