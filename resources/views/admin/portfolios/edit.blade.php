                    ...
                    <form action="{{ route('portfolios.update', $portfolio) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @if($portfolio->annual_report)
                                <div class="mt-1 mb-2">
                                    <a href="{{ Storage::url($portfolio->annual_report) }}" target="_blank" class="inline-flex items-center px-3 py-1 bg-indigo-100 border border-transparent rounded-md font-semibold text-xs text-indigo-700 hover:bg-indigo-200">
                                        View Current File
                                    </a>
                                </div>
                            @endif
                        ...
                        <div class="mb-4">
                            ...
                            @if($portfolio->trust_deed_document)
                                <div class="mt-1 mb-2">
                                    <a href="{{ Storage::url($portfolio->trust_deed_document) }}" target="_blank" class="inline-flex items-center px-3 py-1 bg-indigo-100 border border-transparent rounded-md font-semibold text-xs text-indigo-700 hover:bg-indigo-200">
                                        View Current File
                                    </a>
                                </div>
                            @endif
                        ...
                        <div class="mb-4">
                            ...
                            @if($portfolio->insurance_document)
                                <div class="mt-1 mb-2">
                                    <a href="{{ Storage::url($portfolio->insurance_document) }}" target="_blank" class="inline-flex items-center px-3 py-1 bg-indigo-100 border border-transparent rounded-md font-semibold text-xs text-indigo-700 hover:bg-indigo-200">
                                        View Current File
                                    </a>
                                </div>
                            @endif
                        ...
                        <div class="mb-4">
                            ...
                            @if($portfolio->valuation_report)
                                <div class="mt-1 mb-2">
                                    <a href="{{ Storage::url($portfolio->valuation_report) }}" target="_blank" class="inline-flex items-center px-3 py-1 bg-indigo-100 border border-transparent rounded-md font-semibold text-xs text-indigo-700 hover:bg-indigo-200">
                                        View Current File
                                    </a>
                                </div>
                            @endif
