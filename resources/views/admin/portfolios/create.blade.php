    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('portfolios.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type" class="mt-1 block w-full rounded-md border-gray-300">
                                        ...
                                        <option value="Mixed-Use" {{ old('type') == 'Mixed-Use' ? 'selected' : '' }}>Mixed-Use</option>
                                    </select>
                                    @error('type')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="date" id="foundation_date" name="foundation_date" value="{{ old('foundation_date') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                ...
                                <div>
                                    ...
                                    <input type="date" id="fiscal_year_end" name="fiscal_year_end" value="{{ old('fiscal_year_end') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" id="total_assets" name="total_assets" step="0.01" value="{{ old('total_assets') }}" 
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" id="market_cap" name="market_cap" step="0.01" value="{{ old('market_cap') }}" 
                                            class="mt-1 block w-full pl-7 rounded-md border-gray-300">
                                    </div>
                                    @error('market_cap')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" id="available_funds" name="available_funds" step="0.01" value="{{ old('available_funds') }}" 
                                            class="mt-1 block w-full pl-7 rounded-md border-gray-300">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="target_return" name="target_return" step="0.01" value="{{ old('target_return') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('target_return')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <select id="risk_profile" name="risk_profile" class="mt-1 block w-full rounded-md border-gray-300">
                                        <option value="Low" {{ old('risk_profile') == 'Low' ? 'selected' : '' }}>Low</option>
                                        <option value="Medium" {{ old('risk_profile', 'Medium') == 'Medium' ? 'selected' : '' }}>Medium</option>
                                        <option value="High" {{ old('risk_profile') == 'High' ? 'selected' : '' }}>High</option>
                                    </select>
                                    @error('risk_profile')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="portfolio_manager" name="portfolio_manager" value="{{ old('portfolio_manager') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                ...
                                <div>
                                    ...
                                    <select id="legal_entity_type" name="legal_entity_type" class="mt-1 block w-full rounded-md border-gray-300">
                                        <option value="LLC" {{ old('legal_entity_type', 'LLC') == 'LLC' ? 'selected' : '' }}>LLC</option>
                                        <option value="Corporation" {{ old('legal_entity_type') == 'Corporation' ? 'selected' : '' }}>Corporation</option>
                                        <option value="Partnership" {{ old('legal_entity_type') == 'Partnership' ? 'selected' : '' }}>Partnership</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="investment_strategy" name="investment_strategy" class="mt-1 block w-full rounded-md border-gray-300">
                                        <option value="Growth" {{ old('investment_strategy') == 'Growth' ? 'selected' : '' }}>Growth</option>
                                        <option value="Income" {{ old('investment_strategy', 'Income') == 'Income' ? 'selected' : '' }}>Income</option>
                                        <option value="Value-Add" {{ old('investment_strategy') == 'Value-Add' ? 'selected' : '' }}>Value-Add</option>
                                        <option value="Opportunistic" {{ old('investment_strategy') == 'Opportunistic' ? 'selected' : '' }}>Opportunistic</option>
                                    </select>
