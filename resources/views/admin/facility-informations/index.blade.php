            ...
            <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                <div class="flex items-center justify-between px-4 py-5 sm:px-6">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('admin.facility-informations.trashed') }}" 
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                            ...
                            <div class="flex items-end">
                                ...
                                @if(request('issuer_id') || request('instrument_type') || request('facility_code') || request('search'))
                                    <a href="{{ route('facility-informations.index') }}" class="inline-flex items-center px-4 py-2 ml-2 font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200">
                                        Clear
                                    </a>
                                @endif
                            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Facility Code</th>
                                <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Facility Name</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($facilities as $facility)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-indigo-600 whitespace-nowrap">{{ $facility->facility_code }}</td>
