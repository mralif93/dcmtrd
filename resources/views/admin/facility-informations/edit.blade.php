    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <form action="{{ route('facility-informations.update', $facility) }}" method="POST" class="p-6">
                    @csrf @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="facility_name" id="facility_name" 
                                        value="{{ old('facility_name', $facility->facility_name) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    ...
                                    <select name="instrument_type" id="instrument_type" required
                                        ...
                                        @foreach($instrumentTypes as $instrumentType)
                                            <option value="{{ $instrumentType }}" @selected(old('instrument_type', $facility->instrument_type) == $instrumentType)>
                                                {{ $instrumentType }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="principal_type" id="principal_type" 
                                        value="{{ old('principal_type', $facility->principal_type) }}" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                ...
                                <div>
                                    <label for="guaranteed" class="flex items-center">
                                        <input type="checkbox" name="guaranteed" id="guaranteed" 
                                            class="mr-2" @checked(old('guaranteed', $facility->guaranteed))>
                                        Guaranteed
                                    </label>
                                </div>
                                <div>
