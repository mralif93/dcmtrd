    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Edit Tenant') }}: {{ $tenant->first_name }} {{ $tenant->last_name }}
            </h2>
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="first_name" name="first_name" value="{{ old('first_name', $tenant->first_name) }}" 
                                ...
                                <div>
                                    ...
                                    <input type="text" id="last_name" name="last_name" value="{{ old('last_name', $tenant->last_name) }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('last_name')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" id="ssn" name="ssn" value="{{ old('ssn', $tenant->ssn) }}" placeholder="XXXX" maxlength="4"
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('ssn')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="employer" name="employer" value="{{ old('employer', $tenant->employer) }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    @error('employer')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" id="employer_phone" name="employer_phone" value="{{ old('employer_phone', $tenant->employer_phone) }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="vehicle_make" name="vehicle_make" 
                                        value="{{ old('vehicle_make', $tenant->vehicle_info['make'] ?? '') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="vehicle_model" name="vehicle_model" 
                                        value="{{ old('vehicle_model', $tenant->vehicle_info['model'] ?? '') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="vehicle_year" name="vehicle_year" 
                                        value="{{ old('vehicle_year', $tenant->vehicle_info['year'] ?? '') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="vehicle_color" name="vehicle_color" 
                                        value="{{ old('vehicle_color', $tenant->vehicle_info['color'] ?? '') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="license_plate" name="license_plate" 
                                        value="{{ old('license_plate', $tenant->vehicle_info['license_plate'] ?? '') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" id="background_check_date" name="background_check_date" 
                                        value="{{ old('background_check_date', $tenant->background_check_date ? $tenant->background_check_date->format('Y-m-d') : '') }}" 
                                        class="mt-1 block w-full rounded-md border-gray-300">
                                    ...
                                    <div>
                                        <label for="active_status" class="inline-flex items-center">
                                            <input type="checkbox" id="active_status" name="active_status" value="1" 
                                                {{ old('active_status', $tenant->active_status) ? 'checked' : '' }}
                                                class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div>
                                ...
                                <textarea id="notes" name="notes" rows="3" 
                                    class="mt-1 block w-full rounded-md border-gray-300">{{ old('notes', $tenant->notes) }}</textarea>
                                @error('notes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
