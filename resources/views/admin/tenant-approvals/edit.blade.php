        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('tenant-approvals.update', $tenantApproval->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <select id="tenant_id" name="tenant_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" required>
                                ...
                                @foreach ($tenants as $tenant)
                                    <option value="{{ $tenant->id }}" {{ (old('tenant_id') ?? $tenantApproval->tenant_id) == $tenant->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="checklist_id" name="checklist_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" required>
                                ...
                                @foreach ($checklists as $checklist)
                                    <option value="{{ $checklist->id }}" {{ (old('checklist_id') ?? $tenantApproval->checklist_id) == $checklist->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="lease_id" name="lease_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">
                                ...
                                @foreach ($leases as $lease)
                                    <option value="{{ $lease->id }}" {{ (old('lease_id') ?? $tenantApproval->lease_id) == $lease->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="approval_type" name="approval_type" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" required>
                                <option value="new" {{ (old('approval_type') ?? $tenantApproval->approval_type) == 'new' ? 'selected' : '' }}>New Tenant</option>
                                <option value="renewal" {{ (old('approval_type') ?? $tenantApproval->approval_type) == 'renewal' ? 'selected' : '' }}>Renewal</option>
                            </select>
                            @error('approval_type')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                            ...
                            <fieldset class="border border-gray-300 rounded-md p-4">
                                ...
                                <div class="mb-3">
                                    <div class="flex items-center">
                                        <input id="od_approved" name="od_approved" type="checkbox" value="1" {{ (old('od_approved') ?? $tenantApproval->od_approved) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="od_approval_date" type="date" name="od_approval_date" value="{{ old('od_approval_date', $tenantApproval->od_approval_date ? $tenantApproval->od_approval_date->format('Y-m-d') : '') }}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">
                                ...
                                <div class="mb-3">
                                    <div class="flex items-center">
                                        <input id="ld_verified" name="ld_verified" type="checkbox" value="1" {{ (old('ld_verified') ?? $tenantApproval->ld_verified) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="ld_verification_date" type="date" name="ld_verification_date" value="{{ old('ld_verification_date', $tenantApproval->ld_verification_date ? $tenantApproval->ld_verification_date->format('Y-m-d') : '') }}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">
                        ...
                        <div class="mb-4">
                            <fieldset class="border border-gray-300 rounded-md p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="submitted_to_ld_date" type="date" name="submitted_to_ld_date" value="{{ old('submitted_to_ld_date', $tenantApproval->submitted_to_ld_date ? $tenantApproval->submitted_to_ld_date->format('Y-m-d') : '') }}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="ld_response_date" type="date" name="ld_response_date" value="{{ old('ld_response_date', $tenantApproval->ld_response_date ? $tenantApproval->ld_response_date->format('Y-m-d') : '') }}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="notes" name="notes" rows="3" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">{{ old('notes', $tenantApproval->notes) }}</textarea>
                            @error('notes')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
